...
<svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
    ...
    },
    {
      ...
      description: "Shows a card with a user's profile information when you hover over their username/logo.",
      badge: "",
      svg: (
    ...
    },
    {
      ...
      description: "Shows statuses for admin, verified, beta, and banned users on certain pages.",
      badge: "",
      svg: (
