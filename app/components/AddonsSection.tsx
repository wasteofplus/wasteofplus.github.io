...
const AddonsSection = () => {
  const addons = [
    ...
    {
      id: "profile-hover-cards",
      title: "Profile Hover Cards",
      description:
        "Shows a card with a user's profile information when you hover over their username/logo.",
      badge: "",
      svg: (
        <svg
          className="w-6 h-6 text-gray-800 dark:text-white"
    ...
    },
    {
      ...
      title: "Show User Status Indicators",
      description:
        "Shows statuses for admin, verified, beta, and banned users on certain pages.",
      badge: "",
      svg: (
        <svg
          className="w-6 h-6 text-gray-800 dark:text-white"
    ...
    },
    {
      ...
      description:
        "Sends a message in chat when a user joins or leaves a chat.",
      badge: "",
      svg: (
        <svg
          className="w-6 h-6 text-gray-800 dark:text-white"
  ...
  return (
    <section id="addons" className="bg-white dark:bg-gray-900">
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div className="max-w-screen-md mb-8 lg:mb-16">
          ...
          <p className="text-gray-500 sm:text-xl dark:text-gray-400">
            The list of all addons in wasteof.plus.
          </p>
        </div>
