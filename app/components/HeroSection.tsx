...
const HeroSection = () => {
  return (
    <section id="hero" className="pt-20 bg-white dark:bg-gray-900">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        >
          ...
          <span className="text-sm font-medium">Wasteof.plus alpha is coming soon!</span>
          <svg
        ...
        <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
          ...
          >
            ...
            <svg className="githubIcon w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
