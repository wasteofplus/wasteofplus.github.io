...
const FeatureSection = () => {
  const addons = [
    ...
    },
    {
      ...
      description:
        "With features such as desktop notifications, chat presence notifiers, and post read indicators, using wasteof.money just got better.",
      svg: (
        <svg
          className="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300"
          fill="currentColor"
      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div className="max-w-screen-md mb-8 lg:mb-16">
          ...
          <p className="text-gray-500 sm:text-xl dark:text-gray-400">
            Waste Money in style with a browser extension that adds helpful,
            customizable addons to the wasteof.money social media.
          </p>
        </div>
